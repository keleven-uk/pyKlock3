...
def buildGUI(self):
    ...
    self.txtLegend       = QLabel("Shows Easter dates for the UK.")
    ...
    self.ntpLayout.addWidget(self.txtGoodFriday,   1, 0, Qt.AlignmentFlag.AlignCenter)
    self.ntpLayout.addWidget(self.lblGoodFriday,   1, 1, Qt.AlignmentFlag.AlignLeft)
    self.ntpLayout.addWidget(self.txtEasterSunday, 2, 0, Qt.AlignmentFlag.AlignCenter)
    self.ntpLayout.addWidget(self.lblEasterSunday, 2, 1, Qt.AlignmentFlag.AlignLeft)
    self.ntpLayout.addWidget(self.txtEasterMonday, 3, 0, Qt.AlignmentFlag.AlignCenter)
    self.ntpLayout.addWidget(self.lblEasterMonday, 3, 1, Qt.AlignmentFlag.AlignLeft)
    self.ntpLayout.addWidget(self.txtTypeOfEaster, 4, 0, Qt.AlignmentFlag.AlignCenter)
    self.ntpLayout.addWidget(self.cbTypeOfEaster,  4, 1, Qt.AlignmentFlag.AlignLeft)
    self.ntpLayout.addWidget(self.txtYearOfEaster, 6, 0, Qt.AlignmentFlag.AlignCenter)
    self.ntpLayout.addWidget(self.sbYearOfEaster,  6, 1, Qt.AlignmentFlag.AlignLeft)
